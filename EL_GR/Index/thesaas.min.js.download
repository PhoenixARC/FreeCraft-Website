...
"use strict"; + function(a, b) {
    ...
    c.defaults = {
        ...
        c.topbar(), c.parallax(), c.carousel(), c.scrolling(), c.counter(), c.aos(), c.typed(), c.contact(), c.constellation(), a(document).on("click", '[data-provide~="lightbox"]', lity), a(document).on("click", ".video-wrapper .btn", function() {
        ...
        a("[data-parallax]").each(function() {
            var b = a(this),
                c = b.data("parallax"),
                d = .3;
            a(this).hasClass("header") && (d = .6), b.parallax({
                imageSrc: c,
                speed: d,
                bleed: 50
            })
        ...
        a("[data-countdown]").each(function() {
            var b = "%D day%!D %H:%M:%S",
                c = a(this);
            c.hasDataAttr("format") && (b = c.data("format")), c.countdown(c.data("countdown"), function(a) {
                c.html(a.strftime(b))
            })
        })
    }, c.aos = function() {
        ...
        }), a(document).on("click", ".topbar-reveal .topbar-nav .nav-item", function() {
            var b = a(this);
            b.closest(".topbar-nav").find(".nav-submenu").slideUp(), b.children(".nav-submenu").slideToggle()
        ...
        a(b).width() < 700 ? a(".constellation").constellation({
            distance: 40,
            star: {
...
"use strict"; + function(a, b) {
    ...
    return $(a).html().toUpperCase().indexOf(c[3].toUpperCase()) >= 0
>>>>>>> 548945fe4ee044173af815f466ba9e23f8e2b924
};